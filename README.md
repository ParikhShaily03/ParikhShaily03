# Hi, I'm Shaily Parikh 👋

🎯 Software Engineer | .NET · Angular · Django · Spring Boot  
📍 Ahmedabad, Gujarat, India  
🏢 Currently building @ Gujarat Technological University
...
From designing database schemas to shipping full-stack features,
I've independently built complete modules and new functionality
in production systems used by thousands of students and staff
across Gujarat.

I've developed entire projects end-to-end — not just bug fixes,
not just small tweaks — real, required features that went live.

Clean Architecture, structured APIs, and readable code
...
**Frontend**
Angular · React.js · TypeScript · Tailwind CSS · Bootstrap

**Databases**
SQL Server · MySQL

**Tools**
Playwright · Hangfire · Swagger · IIS · Azure · GitHub
